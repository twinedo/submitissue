...
const UpdatePOD = ({data}) => {
  ...
  const getDataPOD = () => {
    podAPI
      ...
      .then((res) => {
        console.log('ini dataPOD', res.data);
        let tmpOrder = [];
        ...
        },
        {
          ...
          onPress: () => {
            RNFetchBlob.fetch(
              ...
              {
                Authorization:
                  'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..iwJ_c7Txd6qIacan9kfSa8aF9itw1k7EvOKtuNk9nfY',
                otherHeader: 'foo',
                            ...
                            <View
                              ...
                              {item.image == '' ? (
                                <TouchableOpacity
                                  ...
                                  onPress={() =>
                                    addFoto(item.orderNumber, index)
                                  }>
                                  <Image
